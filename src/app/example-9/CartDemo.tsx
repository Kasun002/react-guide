...
export default function CartDemo() {
  // useCartDispatch: stable reference — won't cause re-renders on its own.
  const dispatch = useCartDispatch();

  // useCartState: re-renders this component whenever cart state changes.
  // Use the split-context pattern (state vs dispatch) to avoid re-rendering
  // dispatch-only consumers when state updates.
